      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <button
            ...
            className="px-4 py-2 rounded-md border border-gray-200 flex items-center gap-2 font-semibold"
          >
            <FaArrowLeft /> <span>Previous</span>
          </button>
          <button
            onClick={handleNext}
            className="px-6 py-2 rounded-md bg-[#FF7346] text-white flex items-center gap-2 font-semibold"
          >
