                    ...
                    <div className="w-full max-w-md mx-auto">
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            ...
                            <button
                                ...
                                className="w-full text-white py-3 cursor-pointer
                                rounded-md font-semibold mt-2 hover:bg-opacity-90 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
                            >
