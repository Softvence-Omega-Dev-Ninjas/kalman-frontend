...
const TradeMessage = () => {
  ...
  const handleContactSelect = (contactName:any) => {
          ...
          <div className="p-4 sm:p-6 border-b border-gray-100">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 sm:py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              />
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col bg-[#EFF2F7] rounded-lg border border-gray-100 min-w-0">
          ...
          <div className="bg-white px-4 sm:px-6 py-3 sm:py-4 border-t border-gray-200 rounded-b-lg">
            <div className="flex items-center space-x-2 sm:space-x-3">
              <button className="p-2 text-gray-400 hover:text-gray-600 transition-colors bg-gray-100 rounded-lg flex-shrink-0">
              ...
              <button className="p-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors flex-shrink-0">
          ...
          <div className="flex flex-col h-screen bg-white">
            ...
            <div className="bg-white px-4 py-3 border-t border-gray-200 safe-area-bottom">
              <div className="flex items-center space-x-2">
                ...
                />
                <button className="p-2 bg-orange-500 text-white rounded-full hover:bg-orange-600 transition-colors flex-shrink-0">
