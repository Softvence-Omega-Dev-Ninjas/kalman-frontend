...
const PaymentForm = () => {
  ...
  const canContinue = acceptedPayment && acceptedTerms;
  ...
  <div className="bg-[#FFFCFB] p-4 rounded-lg shadow-sm border-[#FDC6B5] border">
  ...
  <div className=" p-4 rounded-lg shadow-sm border-[#FDC6B5] border bg-[#FFFCFB] ">
  ...
  <label className="text-sm text-gray-700 bg-[#FFFCFB] border-[#FDC6B5] border w-full rounded-lg p-4">
          <div className="flex">
            <div>
              <input
                type="checkbox"
                className="mr-2 size-4 mt-2"
  ...
  <label className="flex items-center text-sm text-gray-700 bg-[#FFFCFB] border-[#FDC6B5] border w-full rounded-lg p-4">
          <input
            type="checkbox"
      ...
      <div className="mt-16 flex justify-between">
       <Link to='/trade-person/credentials'>
        ...
        <button
          type="button"
          onClick={() => canContinue && navigate('/trade-person/business-details')}
          disabled={!canContinue}
          aria-disabled={!canContinue}
          className={
            `flex items-center gap-2 px-6 py-2 rounded-lg ${canContinue ? 'bg-orange-500 text-white hover:bg-orange-600' : 'bg-gray-300 text-gray-500 cursor-not-allowed'}`
          }
        >
          Continue
          <ArrowRight size={18} />
