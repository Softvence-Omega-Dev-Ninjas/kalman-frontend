...
export const blogData = [
  {
    ...
    description:
      "Picking the perfect partner can transform your projects outcome. Learn the key factors that make c...",
    author: "Floyd Miles",
    date: "4/4/18",
  },
  {
    ...
    description:
      "Hiring the wrong fit can be costly. Discover the top mistakes companies make and how to avoid them fo...",
    author: "Floyd Miles",
    date: "4/4/18",
  },
  {
    ...
    description:
      "If you've ever postponed a home project because you couldn't find the time or bear the thought of mak...",
    author: "Jerome Bell",
    date: "4/4/18",
  },
  {
    ...
    description:
      "Small adjustments lead to big wins. Learn practical tips to streamline your processes and boost produc...",
  ...
  },
  {
    ...
    description:
      "Explore proven strategies and insights that help our clients thrive in every situation...",
  ...
  },
  {
    ...
    description:
      "Expert advice isn't just a luxury—it's essential. Discover why partnering with the right professiona...",
    author: "Jacob Jones",
    date: "4/4/18",
  },
  {
    ...
    description:
      "Strong connections drive repeat business. Learn proven strategies to earn trust and maintain client lo...",
  ...
  },
  {
    ...
    description:
      "The right tools can revolutionize your workflow. Explore essential platforms and software that make...",
    author: "Eleanor Pena",
    date: "4/4/18",
  },
];
